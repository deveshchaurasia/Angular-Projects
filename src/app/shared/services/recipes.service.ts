...
export class RecipeService{
    ...
    private recipes:Recipe[] = [
        new Recipe("Momos Recipe", 'Make the dough. Take 1 cup all-purpose flour, ¼ teaspoon salt and ½ teaspoon oil in a bowl. Mix well with a spoon.', 'https://c.ndtvimg.com/2022-07/9f0la2fg_veg-momo_625x300_06_July_22.png'),
        ...
        such as onions, peppers, broccoli, or mushrooms should be sautéed first.`,`https://www.simplyrecipes.com/thmb/CWzxvl8dpC_zkjjRqEE6fBCS6DQ=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Simply-Recipes-Homemade-Pizza-Dough-Lead-Shot-1c-c2b1885d27d4481c9cfe6f6286a64342.jpg`),
